      ...
      <div class="container px-6 py-8 mx-auto">
        <div class="items-center lg:flex">
          <div class="lg:w-1/2">
            ...
            <p class="mt-4 text-gray-500 dark:text-gray-400 lg:max-w-md font-mulish">
              Hi I am Karthikeyan , Front End Engineer{" "}
              <a
              ...
              , from Bangalore , India. I design and build things for the web. I
              have also played around with server side languages like Python,
              Node.js and Ruby.
            </p>
            ...
            <div class="flex items-center justify-center lg:justify-end">
              <div class="max-w-lg">
                <img
                  ...
                  src="https://i.imgur.com/wip852w.jpg"
                  alt=""
                />
              </div>
            </div>
